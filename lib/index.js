...
var ReactFlagsSelect = function (_Component) {
	...
	ReactFlagsSelect.prototype.getVectorName = function getVectorName(countryCode) {
		var countryName = _countries2.default[countryCode].toLowerCase();
		var vectorName = countryName.replace(' ', '-');
		return vectorName;
	};
	...
	ReactFlagsSelect.prototype.render = function render() {
		...
		return _react2.default.createElement(
			...
			_react2.default.createElement(
				'div',
				{ ref: 'selectedFlag', style: { fontSize: selectedSize + 'px' }, className: 'selected--flag--option', onClick: this.toggleOptions },
			...
			this.state.openOptions && _react2.default.createElement(
				'div',
				{ style: { fontSize: optionsSize + 'px' }, className: 'flag-options ' + alignClass },
