...
var ReactFlagsSelect = function (_Component) {
	...
	ReactFlagsSelect.prototype.filterSearch = function filterSearch(evt) {
		...
		var filteredCountries = void 0;
		if (typeof this.props.customFilter === 'function') {
			filteredCountries = _this2.props.customFilter(filterValue, this.state.countries, _countries, _this2.props.customLabels);
		} else {
			filteredCountries = filterValue && this.state.countries.filter(function (key) {
	...
	ReactFlagsSelect.prototype.render = function render() {
		...
		return _react2.default.createElement(
			...
			_react2.default.createElement(
				...
				_react2.default.createElement(
					'span',
					{ className: 'arrow-down ' + ((this.props.disabled || !this.props.showArrow) ? 'hidden' : '') },
					'\u25BE'
				)
			),
